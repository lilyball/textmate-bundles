...
<button>&nbsp;&#x21E7;&#x2318;R&nbsp;</button>
It sends the current document or selection line by line to the Rdaemon. If Rdaemon is not yet running it will start it, and it opens the Rsession project. The file `~/Rdaemon/console.Rcon` will contain the output.
